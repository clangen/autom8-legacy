...
public class ConnectionManagerActivity extends AppCompatActivity {
    ...
    private OnClickListener mOnConnectionItemInfoClicked = new OnClickListener() {
    ...
    private OnClickListener mOnCloseClicked = new OnClickListener() {
        public void onClick(View view) {
            finish();
        }
    };

    private OnClickListener mOnAddConnectionClicked = new OnClickListener() {
        public void onClick(View view) {
            EditConnectionActivity.start(ConnectionManagerActivity.this);
        }
    };

    private OnClickListener mOnEditConnectionClicked = new OnClickListener() {
        public void onClick(View view) {
    ...
    private OnClickListener mOnDeleteConnectionClicked = new OnClickListener() {
        public void onClick(View view) {
            ItemViewHolder holder = (ItemViewHolder) view.getTag();
    ...
    private BaseAdapter mListAdapter = new BaseAdapter() {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            holder.mRow.setOnClickListener(mOnConnectionItemInfoClicked);
